...
# ========= SETTINGS =========
data_dir = "/Users/ned/GitHub/MentalRot_analysis/60/pre_60/pre_60_data"   # folder containing CSVs, "." means current directory
os.makedirs("pre_60_outputs", exist_ok=True)
output_prefix = "pre_outputs/MentalRotation_CORRECT_ONLY"
angle_col = "angle"
